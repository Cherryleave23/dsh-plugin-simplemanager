...
export const s: Record<string, CSSProperties> = {
  ...
  // 工具管理：就地选卡时被勾选的插件卡——高亮变色 + 发光描边。
  toolCardSelected: {
    boxShadow: '0 0 0 2px var(--dsw-alias-state-success-primary), var(--dsw-shadow-lv2)',
    background: 'color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, var(--dsw-alias-bg-layer-1))',
  },
  // 工具管理：选中卡右侧的「已选」勾选徽标。
  toolCardCheck: {
    ...pillBase,
  ...
  toolScanHint: {
    ...
    border: '1px dashed color-mix(in srgb, var(--dsw-alias-state-success-primary) 45%, transparent)',
    color: 'var(--dsw-alias-label-secondary)',
    fontSize: 12,
  },
